...
class ContributionsControllerTest < ActionController::TestCase
  ...
  test "should create contribution" do
    assert_difference('Contribution.count') do
      post :create, contribution: { comentarios: @contribution.comentarios, puntos: @contribution.puntos, text: @contribution.text, tipo: @contribution.tipo, titulo: @contribution.titulo, url: @contribution.url, user_id: @contribution.user_id }
    end
  ...
  test "should update contribution" do
    patch :update, id: @contribution, contribution: { comentarios: @contribution.comentarios, puntos: @contribution.puntos, text: @contribution.text, tipo: @contribution.tipo, titulo: @contribution.titulo, url: @contribution.url, user_id: @contribution.user_id }
    assert_redirected_to contribution_path(assigns(:contribution))
  end
